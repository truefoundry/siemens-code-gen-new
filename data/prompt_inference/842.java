...
public class TC05_Admin_User_Management_Functionality_Check
{
    ...
    void Admin_User_Management_Functionality_Check()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.ADMIN, "842", tc ->
        {
            ...
            WaitFor.condition(() -> tc.page.containsTiles("User Management", "Escalation Criteria", "Admin Ruleset"));
            tc.addStepInfo("Page with 3 options for admins is displayed", true, tc.page.containsTiles("User Management", "Escalation Criteria", "Admin Ruleset"),
                    new ComparerOptions().takeScreenShotPlatform());

            //Step 3
            boolean containsTiles = tc.page.containsTiles("User Management", "Escalation Criteria", "Admin Ruleset");
            tc.addStepInfo("Page contains tiles: User Management, Escalation Criteria, Admin Ruleset", true, containsTiles,
                    new ComparerOptions().takeScreenShotPlatform());
            ...
            //Step 5
            tc.edit.sendKeys(EEdit.SEARCH_FIELD, "GID or part of User name or e-mail");
