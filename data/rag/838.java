...
public class TC05_Digital_Customer_Portal_Test {

    @Test
    void Digital_Customer_Portal_Test() {
        IocBuilder.execute(Duration.ofMinutes(15), EResultData.ADMIN, "842", tc -> {
            ...
            // Step 3: Check page tile content
            boolean pageTileContent = tc.tile.exists(ETile.REPORT_AN_ISSUE) &&
            ...
            tc.addStepInfo("Landing page tile content is according to screenshot", true, pageTileContent,
                    new ComparerOptions().takeScreenShotPlatform());
