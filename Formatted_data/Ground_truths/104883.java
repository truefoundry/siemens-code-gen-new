...
public class TC03_Zone_Operation_Lead_Role_Schedule_Task_Notification_Actions_Site_Assigned_Engineers
{
    @ParameterizedTest
    @ArgumentsSource(ZoneOperationTestEnvironmentProvider.class)
    @ZoneOperationTestCaseId("104883")
    void TC_03(Map<String,String> data)
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104883", tc ->
        {
            ...
            //Step 5
            tc.notification.performActions(EAction.SITE_ASSIGNED_ENGINEERS);
