...
public class TC29_Zone_Operation_Lead_Role_Views_Task_NotificationListItem_Edit_Ok
{
    @Test
    void TC_29()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104909", tc ->
        {
            ...
            tc.edit.sendKeys(EEdit.byIndex(1),notification_Number,true);
            ...
            tc.stepEvaluator
                    ...
                    .add(()-> tc.button.isDisplayed(EButton.EXPORT), "'%s' button not found!".formatted(EButton.EXPORT))
                    .add(()-> tc.button.isDisplayed(EButton.REFRESH), "'%s' button not found!".formatted(EButton.REFRESH))
                    .add(()-> tc.table.getItemsFromColumn(ETable.CAD_TABLE,EColumn.NOTIFICATION_NUMBER).contains(notification_Number), "The values has not been edited");
