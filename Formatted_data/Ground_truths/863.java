...
public class TC05_External_User_Question_About_My_Account
{
    @Test
    void User_Question_About_My_Account()
    {
        IocBuilder.execute(Duration.ofMinutes(20), EResultData.EXTERNAL_USER, "863", tc ->
        {
