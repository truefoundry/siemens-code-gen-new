...
public class TC08_Dispatcher_Education_Role_Schedule_Task_Notification_Actions_PinTask
{
    @ParameterizedTest
    @ArgumentsSource(EducationTestEnvironmentProvider.class)
    @EducationTestCaseId("115723")
    void TC_08(Map<String,String> data)
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_EDUCATION_ROLE, "115723", tc ->
        {
