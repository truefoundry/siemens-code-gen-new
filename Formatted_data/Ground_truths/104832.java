...
public class TC19_Dispatcher_Role_View_Capacity_Used_Daily_New
{
    @Test
    void TC_19()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104832", tc ->
        {
            ...
            tc.addStepInfo("The following fields should be in Periodic Capacity:Name,District,Task " +
                    ...
                    true, tc.table.getAllColumnNames(ETable.CAD_TABLE).containsAll(List.of("Name","District",
                            "Task Type Category","EntryDate","CapacityThreshold","ActualCapacityUsed")),
                    new ComparerOptions().takeScreenShotPlatform());
