...
public class TC18_Zone_Operation_Lead_Role_Views_CapacityLimitations_CapacityLimitListItem_Edit_OK
{
    @Test
    void TC_18()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104898", tc ->
        {
