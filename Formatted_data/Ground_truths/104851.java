...
public class TC02_Dispatcher_Role_HomeScreen_Notification
{
    @Test
    void TC_02()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104851", tc ->
        {
            ...
            tc.checkbox.check(ECheckBox.INVITRO);
