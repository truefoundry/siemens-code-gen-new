...
public class TC05_Zone_Operation_Lead_Role_Schedule_Task_Notification_Actions_Show_on_Map
{
    @ParameterizedTest
    @ArgumentsSource(ZoneOperationTestEnvironmentProvider.class)
    @ZoneOperationTestCaseId("104885")
    void TC_05(Map<String,String> data)
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104885", tc ->
        {
