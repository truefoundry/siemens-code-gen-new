...
public class TC11_Dispatcher_Role_Schedule_ClipBoard_Notification_Actions_GetCandidates
{
    @ParameterizedTest
    ...
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104824", tc ->
        {
            ...
            tc.addStepInfo("Rules Violation Window should be reflected with close button",
                    true,tc.modal.getTitle().equals("No Candidates Found")&&tc.button.isDisplayed(EButton.CLOSE),
                    new ComparerOptions().takeScreenShotPlatform());
