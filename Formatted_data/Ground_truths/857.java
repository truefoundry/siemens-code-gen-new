...
public class TC04_External_User_Question_About_An_Order_Or_eSupport_Assistance
{
    @Test
    void Question_About_An_Order_Or_eSupport_Assistance()
    {
        IocBuilder.execute(Duration.ofMinutes(20), EResultData.EXTERNAL_USER, "857", tc ->
        {
            final String number = "0123456789";
            final String country = "United States of America";
            final String state = "Alaska";
            final String language = "en";
            final String shsTeam = "eSupport";
            ...
            WaitFor.condition(tc.modal::exists, Duration.ofSeconds(80));
            ...
            WaitFor.condition(() -> tc.edit.exists(EEdit.SOLD_TO));
            tc.stepEvaluator
                    .add(() -> tc.edit.getValue(EEdit.SUBJECT).equalsIgnoreCase(subject), "subject is not editable")
                    .add(() -> tc.edit.getValue(EEdit.REASON).equalsIgnoreCase(reason), "reason is not editable")
                    .add(() -> tc.edit.exists(EEdit.SOLD_TO), "Sold to is not editable")
