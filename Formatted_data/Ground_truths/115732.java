...
public class TC17_Dispatcher_Education_Role_View_Education_WaitList_Delete
{
    @Test
    void TC_17()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_EDUCATION_ROLE, "115732", tc ->
        {
