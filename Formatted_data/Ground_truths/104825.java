...
public class TC12_Dispatcher_Role_Schedule_ClipBoard_Notification_Actions_BookAppointment
{
    @ParameterizedTest
    @ArgumentsSource(DispatcherTestEnvironmentProvider.class)
    @DispatcherTestCaseId("104825")
    void TC12(Map<String,String> data)
    {
        IocBuilder.execute(Duration.ofMinutes(8), EResultData.TMF_DISPATCHER_ROLE, "104825", tc ->
        {
            final String notification = data.get("notification");
            tc.browser.start(WebDrv.CHROME, ETestData.URL, ETestData.DISPATCHER_ROLE_USER);
            ...
            List<String> expectedActions = List.of("Edit", "Site Assigned Engineers","Change Status",
            ...
            tc.addStepInfo("Below options should be reflected for each notification 'notification', 'Edit', " +
                            ...
                            "'Pin Task', 'Comment', 'Check Rules', 'Get Candidates', 'Schedule','Unschedule','Relaxed Get Candidates'" +
