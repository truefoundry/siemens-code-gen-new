...
public class TC22_Dispatcher_Education_Role_Views_Engineer_ListofEngineers
{
    @Test
    void TC_22()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_EDUCATION_ROLE, "115737", tc ->
        {
