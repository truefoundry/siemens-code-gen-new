...
public class TC24_Zone_Operation_Lead_Role_Views_EducationWaitlist_EducationWaitlist_ListItem_Edit_Ok
{
    @Test
    void TC_24()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104904", tc ->
        {
