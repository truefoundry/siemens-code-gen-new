...
public class TC02_Zone_Operation_Lead_Role_HomeScreen_Notification
{
    @Test
    void TC_02()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104918", tc ->
        {
            ...
            tc.checkbox.check(ECheckBox.INSTALLATION);
