...
public class TC21_Zone_Operation_Lead_Role_Views_EducationWaitlist_New
{
    @Test
    void TC_21()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104901", tc ->
        {
