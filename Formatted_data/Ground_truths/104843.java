...
public class TC30_Dispatcher_Role_Views_Task_Manage_Filters_Advance_Filter_Conditions
{
    @Test
    void TC_30()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104843", tc ->
        {
