...
public class TC20_Dispatcher_Role_Views_CapacityUsedDaily_CapacityUsedDailyListItem
{
    @Test
    void TC_20()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104833", tc ->
        {
