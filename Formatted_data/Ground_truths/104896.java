...
public class TC16_Zone_Operation_Lead_Role_CalendarManagement_Resources_AnyResourcesItem
{
    @Test
    void TC_16()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104896", tc ->
        {
