...
public class TC23_Dispatcher_Role_View_Education_WaitList_Delete
{
    @Test
    void TC_23()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104836", tc ->
        {

            String notification_Number = new SimpleDateFormat("yyyyMMddHHmmssSSS").format(new Date()).substring(9);;
            String preferred_ces = "Tester10";
