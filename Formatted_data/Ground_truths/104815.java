...
public class TC02_Dispatcher_Role_Schedule_Task_Notification_Actions_Edit
{
    @ParameterizedTest
    @ArgumentsSource(DispatcherTestEnvironmentProvider.class)
    @DispatcherTestCaseId("104815")
    void TC_02(Map<String,String> data)
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_DISPATCHER_ROLE, "104815", tc ->
        {
            ...
            tc.notification.expandActions("#0");
             tc.addStepInfo("Below options should be reflected for each notification 'notification', 'Edit', " +
                    ...
                    tc.notification.getAllActions().containsAll(List.of("Edit", "Site Assigned Engineers","Change Status",
                            "Show on Gantt", "Show on Map", "Remove from Clipboard", "Pin Task" ,
