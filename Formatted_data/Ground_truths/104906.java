...
public class TC26_Zone_Operation_Lead_Role_View_Resource_Territory_Export
{
    @Test
    void TC_26()
    {
        IocBuilder.execute(Duration.ofMinutes(10), EResultData.TMF_ZONE_OPERATION_LEAD_ROLE, "104906", tc ->
        {
